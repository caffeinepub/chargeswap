...
export class Backend implements backendInterface {
    ...
    async getBalance(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getTransactionHistory(arg0: bigint): Promise<Array<Transfer>> {
        if (this.processError) {
            try {
    ...
    async getUserByPhone(arg0: string): Promise<User> {
        if (this.processError) {
            try {
    ...
    async register(arg0: RegistrationInput): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async transfer(arg0: Transfer): Promise<void> {
        if (this.processError) {
            try {
